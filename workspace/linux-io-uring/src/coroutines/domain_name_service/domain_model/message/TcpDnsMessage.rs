...
impl TcpDnsMessage
{
	...
	#[inline(always)]
	pub(crate) fn write_query_tcp_message(buffer_pointer: usize, message_identifier: MessageIdentifier, data_type: DataType, query_name: &CaseFoldedName<'static>) -> usize
	{
