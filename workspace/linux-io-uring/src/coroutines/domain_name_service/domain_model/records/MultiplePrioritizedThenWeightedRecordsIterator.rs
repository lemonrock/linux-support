...
#[derive(Debug)]
pub struct MultiplePrioritizedThenWeightedRecordsIterator<'a, OR: OwnedRecord + 'a>
{
	source: &'a Vec<MultiplePrioritizedThenWeightedRecordsItem<OR>>,
	
	next_priority_starts_at_index: usize,
}

impl<'a, OR: OwnedRecord + 'a> Iterator for MultiplePrioritizedThenWeightedRecordsIterator<'a, OR>
{
	type Item = MultiplePrioritizedThenWeightedRecordsIteratorPriorityIterator<'a, OR>;
	...
	fn next(&mut self) -> Option<Self::Item>
	{
		...
		else
		{
			...
			let iterator = MultiplePrioritizedThenWeightedRecordsIteratorPriorityIterator::new( self.source, current_next_priority_starts_at_index,  new_next_priority_starts_at_index);
