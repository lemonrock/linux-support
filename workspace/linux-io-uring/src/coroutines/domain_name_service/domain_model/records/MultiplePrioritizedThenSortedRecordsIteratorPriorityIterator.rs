...
/// An iterator.
#[derive(Debug, Clone)]
pub struct MultiplePrioritizedThenSortedRecordsIteratorPriorityIterator<'a, OR: OwnedRecord + 'a>
{
...
impl<'a, OR: OwnedRecord + 'a> Iterator for MultiplePrioritizedThenSortedRecordsIteratorPriorityIterator<'a, OR>
{
	type Item = &'a OR;
