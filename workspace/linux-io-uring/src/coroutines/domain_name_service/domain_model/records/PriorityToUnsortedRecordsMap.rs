...
{
	type Target = BTreeMap<Priority, Vec<ParsedRecord>>;
...
impl<OR: OwnedRecord> DerefMut for PriorityToUnsortedRecordsMap<OR>
{
	#[inline(always)]
...
impl<OR: OwnedRecord> PriorityToUnsortedRecordsMap<OR>
{
	#[inline(always)]
	fn new_for_one(priority: Priority, record: OR) -> Self
	{
		Self
		(
			btreemap!
