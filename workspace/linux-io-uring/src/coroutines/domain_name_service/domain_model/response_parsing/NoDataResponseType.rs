...
impl<'cache> NoDataResponseType<'cache>
{
	...
	fn negative_cache_until_for_negative_response(&self) -> NegativeCacheUntil
	{
		...
		match self
		{
			&NoDataResponseType1(AuthorityNameStartOfAuthorityNameServers { start_of_authority: (negative_cache_until, _), .. }) => negative_cache_until,
			
			&NoDataResponseType2(AuthorityNameStartOfAuthority { start_of_authority: (negative_cache_until, _), .. }) => negative_cache_until,
