...
#[derive(Debug)]
pub(crate) struct CoroutineManagers<CoroutineHeapSize: 'static + MemorySize, GTACSA: 'static + GlobalThreadAndCoroutineSwitchableAllocator<CoroutineHeapSize>, AcceptStackSize: MemorySize>
{
	_0: CoroutineManager<CoroutineHeapSize, AcceptStackSize, GTACSA, AcceptCoroutine<SocketAddrV4, CoroutineHeapSize, GTACSA, InternetProtocolVersion4AccessControl<AccessControlValue>>, AcceptCoroutineInformation>,
	_1: CoroutineManager<CoroutineHeapSize, AcceptStackSize, GTACSA, AcceptCoroutine<SocketAddrV6, CoroutineHeapSize, GTACSA, InternetProtocolVersion6AccessControl<AccessControlValue>>, AcceptCoroutineInformation>,
