...
///
/// `XCON` stands for 'Centralized Conferencing'.
///
/// `CCMP` is an acronym for Centralized Conferencing Manipulation Protocol.
fn centralized_conferencing() -> HashMap<&'static str, &'static str>
{
	hashmap!
	{
