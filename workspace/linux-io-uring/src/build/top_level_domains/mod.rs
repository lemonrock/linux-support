...
{
	println!("cargo:rerun-if-changed={}", "src/build/top_level_domains/CaseFoldedLabel.rs");
	println!("cargo:rerun-if-changed={}", "src/build/top_level_domains/from_iana_comment.rs");
	println!("cargo:rerun-if-changed={}", "src/build/top_level_domains/top_level_domains.rs");
	println!("cargo:rerun-if-changed={}", "src/build/top_level_domains/TopLevelDomainsRelativeFilePath.rs");
	println!("cargo:rerun-if-changed={}", "src/build/top_level_domains/write_case_folded_labels.rs");
	println!("cargo:rerun-if-changed={}", "src/build/top_level_domains/write_case_folded_names.rs");
