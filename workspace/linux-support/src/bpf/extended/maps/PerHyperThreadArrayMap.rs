...
impl<V: Copy> PerHyperThreadArrayMap<V>
{
	...
	{
		Self::create(map_file_descriptors, map_name, parsed_btf_map_data, MapType::ArrayPerHyperThread(Self::value_size(), maximum_entries, access_permissions), maximum_entries, number_of_possible_hyper_threads)
	}
