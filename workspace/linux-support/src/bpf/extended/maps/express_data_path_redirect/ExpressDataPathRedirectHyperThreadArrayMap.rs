...
pub struct ExpressDataPathRedirectHyperThreadArrayMap
{
	map_file_descriptor: Rc<MapFileDescriptor>,
	maximum_entries: MaximumEntries,
}

impl CanBeInnerMap for ExpressDataPathRedirectHyperThreadArrayMap
{
	#[inline(always)]
...
impl ExpressDataPathRedirectHyperThreadArrayMap
{
	/// New u32 array.
	///
	/// Needs the capability `CAP_SYS_ADMIN`.
	#[inline(always)]
	pub fn new_xdp_redirect_hyper_thread_array(map_file_descriptors: &mut FileDescriptorLabelsMap<MapFileDescriptor>, map_name: &MapName, parsed_bpf_type_format_map_data: Option<&ParsedBpfTypeFormatMapData>, maximum_entries: MaximumEntries, numa_node: Option<NumaNode>) -> Result<Self, MapCreationError>
	{
		Self::create(map_file_descriptors, map_name, parsed_bpf_type_format_map_data, MapType::ExpressDataPathRedirectToHyperThreadArray(maximum_entries, numa_node), maximum_entries)
	}
