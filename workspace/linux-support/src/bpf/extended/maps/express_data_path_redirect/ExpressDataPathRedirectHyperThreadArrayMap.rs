...
impl ExpressDataPathRedirectHyperThreadArrayMap
{
	...
	#[inline(always)]
	pub fn new_xdp_redirect_hyper_thread_array(map_file_descriptors: &mut FileDescriptorsMap<MapFileDescriptor>, map_name: &MapName, parsed_bpf_type_format_map_data: Option<&ParsedBpfTypeFormatMapData>, maximum_entries: MaximumEntries, numa_node: Option<NumaNode>) -> Result<Self, MapCreationError>
	{
