...
pub struct WithoutNumaNodeSocketU32ArrayMapConstructor;

impl MapConstructor for WithoutNumaNodeSocketU32ArrayMapConstructor
{
	const Singleton: Self = Self;
	
	type Map = SocketArrayMap<u32>;
	...
	{
		SocketArrayMap::new_u32(map_file_descriptors, map_name, parsed_bpf_type_format_map_data, maximum_entries, access_permissions, None)
	}
}
