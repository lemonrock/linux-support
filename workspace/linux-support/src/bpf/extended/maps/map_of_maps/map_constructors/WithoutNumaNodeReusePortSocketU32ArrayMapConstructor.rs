...
pub struct WithoutNumaNodeReusePortSocketU32ArrayMapConstructor;

impl MapConstructor for WithoutNumaNodeReusePortSocketU32ArrayMapConstructor
{
	...
	{
		ReusePortSocketArrayMap::new_u32(map_file_descriptors, map_name, parsed_bpf_type_format_map_data, maximum_entries, access_permissions, None)
	}
}
