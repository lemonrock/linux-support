...
pub struct WithoutNumaNodeStackMapConstructor<V: Copy>(PhantomData<V>);

impl<V: Copy> MapConstructor for WithoutNumaNodeStackMapConstructor<V>
{
	...
	{
		QueueOrStackMap::new_stack(map_file_descriptors, map_name, parsed_bpf_type_format_map_data, maximum_entries, access_permissions, None)
	}
}
