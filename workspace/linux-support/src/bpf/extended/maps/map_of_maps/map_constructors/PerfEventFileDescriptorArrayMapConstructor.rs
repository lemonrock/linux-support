...
pub struct PerfEventFileDescriptorArrayMapConstructor;

impl MapConstructor for PerfEventFileDescriptorArrayMapConstructor
{
	const Singleton: Self = Self;
	
	type Map = FileDescriptorArrayMap<PerfEventFileDescriptor>;
