...
pub struct WithoutNumaNodeStackTraceMapInstructionPointerMapConstructor;

impl MapConstructor for WithoutNumaNodeStackTraceMapInstructionPointerMapConstructor
{
	...
	type VariableArguments = StackDepth;
	...
	{
		let stack_depth = variable_arguments;
		StackTraceMap::new_instruction_pointer(map_file_descriptors, map_name, parsed_bpf_type_format_map_data, maximum_entries, access_permissions, None, stack_depth)
	}
}
