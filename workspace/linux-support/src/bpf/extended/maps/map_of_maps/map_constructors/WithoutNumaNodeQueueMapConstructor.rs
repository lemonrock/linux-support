...
pub struct WithoutNumaNodeQueueMapConstructor<V: Copy>(PhantomData<V>);

impl<V: Copy> MapConstructor for WithoutNumaNodeQueueMapConstructor<V>
{
	...
	{
		QueueOrStackMap::new_queue(map_file_descriptors, map_name, parsed_bpf_type_format_map_data, maximum_entries, access_permissions, None)
	}
}
