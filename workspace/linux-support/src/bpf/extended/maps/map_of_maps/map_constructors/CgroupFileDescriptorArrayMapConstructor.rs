...
pub struct CgroupFileDescriptorArrayMapConstructor;

impl MapConstructor for CgroupFileDescriptorArrayMapConstructor
{
	const Singleton: Self = Self;
	
	type Map = FileDescriptorArrayMap<CgroupFileDescriptor>;
	...
	{
		FileDescriptorArrayMap::new_cgroup(map_file_descriptors, map_name, parsed_bpf_type_format_map_data, maximum_entries, access_permissions)
	}
}
