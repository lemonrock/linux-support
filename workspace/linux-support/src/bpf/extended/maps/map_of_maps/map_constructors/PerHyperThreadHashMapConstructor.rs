...
pub struct PerHyperThreadHashMapConstructor<K: Copy, V: Copy>(PhantomData<(K, V)>);

impl<K: Copy, V: Copy> MapConstructor for PerHyperThreadHashMapConstructor<K, V>
{
	...
	type InvariantArguments = (NumberOfPossibleHyperThreads, Preallocation);
