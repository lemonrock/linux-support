...
pub struct WithoutNumaNodeExpressDataPathRedirectHyperThreadArrayMapConstructor;

impl MapConstructor for WithoutNumaNodeExpressDataPathRedirectHyperThreadArrayMapConstructor
{
	...
	{
		ExpressDataPathRedirectHyperThreadArrayMap::new_xdp_redirect_hyper_thread_array(map_file_descriptors, map_name, parsed_bpf_type_format_map_data, maximum_entries, None)
	}
}
