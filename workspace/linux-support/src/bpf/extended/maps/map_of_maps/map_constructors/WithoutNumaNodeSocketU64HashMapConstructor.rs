...
pub struct WithoutNumaNodeSocketU64HashMapConstructor<K: Copy>(PhantomData<K>);

impl<K: Copy> MapConstructor for WithoutNumaNodeSocketU64HashMapConstructor<K>
{
	...
	{
		SocketHashMap::new_u64(map_file_descriptors, map_name, parsed_bpf_type_format_map_data, maximum_entries, access_permissions, None)
	}
}
