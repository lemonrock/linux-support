...
impl<V: Copy> CgroupStorageMap<V>
{
	...
	{
		Self::create(map_file_descriptors, map_name, parsed_btf_map_data, MapType::CgroupStorageSystemWide(Self::value_size(), access_permissions, numa_node), maximum_entries)
	}
