...
pub struct WithoutNumaNodeXdpRedirectSocketArrayMapConstructor;

impl MapConstructor for WithoutNumaNodeXdpRedirectSocketArrayMapConstructor
{
	...
	{
		XdpRedirectSocketArrayMap::new_xdp_redirect_socket_array(map_file_descriptors, map_name, parsed_btf_map_data, maximum_entries, access_permissions, None)
	}
}
