...
pub struct WithoutNumaNodeSocketU64ArrayMapConstructor;

impl MapConstructor for WithoutNumaNodeSocketU64ArrayMapConstructor
{
	...
	{
		SocketArrayMap::new_u64(map_file_descriptors, map_name, parsed_bpf_type_format_map_data, maximum_entries, access_permissions, None)
	}
}
