...
pub struct WithoutNumaNodeXdpRedirectHyperThreadArrayMapConstructor;

impl MapConstructor for WithoutNumaNodeXdpRedirectHyperThreadArrayMapConstructor
{
	...
	{
		XdpRedirectHyperThreadArrayMap::new_xdp_redirect_hyper_thread_array(map_file_descriptors, map_name, parsed_btf_map_data, maximum_entries, None)
	}
}
