...
impl<V: Copy> QueueOrStackMap<V>
{
	/// New queue.
	#[inline(always)]
	pub fn new_queue(map_file_descriptors: &mut FileDescriptorLabelsMap<MapFileDescriptor>, map_name: &MapName, parsed_btf_map_data: Option<&ParsedBtfMapData>, maximum_entries: MaximumEntries, access_permissions: AccessPermissions, numa_node: Option<NumaNode>) -> Result<Self, MapCreationError>
	{
		Self::create(map_file_descriptors, map_name, parsed_btf_map_data, MapType::Queue(Self::value_size(), maximum_entries, access_permissions, numa_node), maximum_entries)
	}
	
	/// New stack.
	#[inline(always)]
	pub fn new_stack(map_file_descriptors: &mut FileDescriptorLabelsMap<MapFileDescriptor>, map_name: &MapName, parsed_btf_map_data: Option<&ParsedBtfMapData>, maximum_entries: MaximumEntries, access_permissions: AccessPermissions, numa_node: Option<NumaNode>) -> Result<Self, MapCreationError>
	{
		Self::create(map_file_descriptors, map_name, parsed_btf_map_data, MapType::Stack(Self::value_size(), maximum_entries, access_permissions, numa_node), maximum_entries)
	}
