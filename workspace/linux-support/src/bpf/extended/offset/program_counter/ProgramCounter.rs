...
impl ProgramCounter
{
	...
	#[inline(always)]
	fn offset_to_label(self, from_program_counter: Self, error_if_too_large: InstructionError, maximum: u64, minimum: u64) -> Result<i32, InstructionError>
	{
		...
		{
			return Err(InstructionError::JumpOffsetOfNegativeOneCreatesAnInfiniteJumpLoop)
		}
	}
}
