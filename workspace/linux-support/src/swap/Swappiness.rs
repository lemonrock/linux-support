...
/// Swappiness.
///
/// The default value in Linux is 60.
///
/// A value of `_0` disables swap.
#[allow(missing_docs)]
...
impl Swappiness
{
	...
	{
		assert_effective_user_id_is_root("write /proc/sys/vm/swappiness");
	...
	#[inline(always)]
	fn swappiness_file_path(proc_path: &ProcPath) -> PathBuf
	{
		proc_path.sys_vm_file_path("swappiness")
	}
}
