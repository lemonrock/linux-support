...
pub struct Layer4ReceiveSideScalingFlowHashKey
{
...
impl From<RXH> for Layer4ReceiveSideScalingFlowHashKey
{
	#[inline(always)]
...
impl ToDataField for Layer4ReceiveSideScalingFlowHashKey
{
	#[inline(always)]
