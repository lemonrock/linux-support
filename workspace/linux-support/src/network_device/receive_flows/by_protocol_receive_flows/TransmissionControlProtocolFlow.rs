...
/// Transmission Control Protocol (TCP) flow over either Internet Protocol version 4 or Internet Protocol version 6.
///
...
impl<IPA: InternetProtocolAddress + Unmasked> Deref for TransmissionControlProtocolFlow<IPA>
{
...
impl<IPA: InternetProtocolAddress + Unmasked> From<CommonLayer4Flow<IPA>> for TransmissionControlProtocolFlow<IPA>
{
	#[inline(always)]
...
impl DataAndMasks for TransmissionControlProtocolFlow<in_addr>
{
	#[inline(always)]
...
impl DataAndMasks for TransmissionControlProtocolFlow<in6_addr>
{
	#[inline(always)]
	fn data_and_masks(&self) -> (ethtool_flow_union, ethtool_flow_union)
	{
