...
/// IPSec Encapsulating Security Payload (ESP) flow over either Internet Protocol version 4 or Internet Protocol version 6.
///
/// `ethtool` calls this either `esp4` or `esp6`.
#[derive(Default, Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[derive(Deserialize, Serialize)]
#[repr(transparent)]
pub struct IpsecEncapsulatingSecurityPayloadFlow<IPA: InternetProtocolAddress + Unmasked>(IpsecFlow<IPA>);

impl<IPA: InternetProtocolAddress + Unmasked> From<IpsecFlow<IPA>> for IpsecEncapsulatingSecurityPayloadFlow<IPA>
{
	#[inline(always)]
...
impl<IPA: InternetProtocolAddress + Unmasked> Deref for IpsecEncapsulatingSecurityPayloadFlow<IPA>
{
...
impl DataAndMasks for IpsecEncapsulatingSecurityPayloadFlow<in_addr>
{
	#[inline(always)]
...
impl DataAndMasks for IpsecEncapsulatingSecurityPayloadFlow<in6_addr>
{
	#[inline(always)]
	fn data_and_masks(&self) -> (ethtool_flow_union, ethtool_flow_union)
	{
