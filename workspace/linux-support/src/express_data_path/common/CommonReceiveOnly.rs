...
impl<RP: ReceivePoll> CommonReceiveOnly<RP>
{
	...
	#[inline(always)]
	pub(crate) fn remove_receive_map_queue_identifier(&self, redirect_map_and_attached_program: &RedirectMapAndAttachedProgram) -> Result<bool, SystemCallErrorNumber>
	{
