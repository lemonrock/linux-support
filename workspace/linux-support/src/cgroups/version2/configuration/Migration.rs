...
{
	fn leaf_migrate<'name, C: Cgroup<'name>>(&self, mount_point: &CgroupMountPoint, cgroup: &C) -> io::Result<()>
	{
	...
	fn migrate<'name, C: Cgroup<'name>>(&self, mount_point: &CgroupMountPoint, cgroup: &C)
	{
