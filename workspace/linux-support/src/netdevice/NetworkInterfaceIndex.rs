...
{
	type Error = NetworkInterfaceNameToSomethingError;
...
impl TryFrom<NetworkInterfaceName> for NetworkInterfaceIndex
{
	...
	{
		Self::try_from_network_interface_name(value)?.ok_or(NetworkInterfaceIndexToNetworkInterfaceNameError::NetworkDeviceInputOutputControl)
	}
}
