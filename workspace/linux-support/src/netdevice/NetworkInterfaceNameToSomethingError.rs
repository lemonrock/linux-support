...
pub enum NetworkInterfaceNameToSomethingError<E: error::Error>
{
...
impl<E: error::Error> Display for NetworkInterfaceNameToSomethingError<E>
{
	#[inline(always)]
...
impl<E: error::Error> error::Error for NetworkInterfaceNameToSomethingError<E>
{
	#[inline(always)]
...
impl<E: error::Error> From<NetworkDeviceInputOutputControlError<E>> for NetworkInterfaceNameToSomethingError<E>
{
	#[inline(always)]
