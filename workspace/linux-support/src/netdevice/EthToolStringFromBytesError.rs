...
pub enum EthToolStringFromBytesError
{
	/// More than `EthToolString::MaximumEthToolStringLengthExcludingAsciiNul` bytes.
	TooLong(usize),
...
impl Display for EthToolStringFromBytesError
{
	#[inline(always)]
...
impl error::Error for EthToolStringFromBytesError
{
}
