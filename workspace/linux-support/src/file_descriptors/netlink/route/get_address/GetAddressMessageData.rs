...
pub struct GetAddressMessageData<IPA: InternetProtocolAddress>
{
	...
	/// `0..=32` for IPv4.
	/// `0..=128` for IPv6.
	pub(crate) mask_length_in_bits: u8,
	...
	pub(crate) interface_index: Option<NetworkInterfaceIndex>,
	
	pub(crate) scope: rt_scope,
	...
	pub(crate) label: Option<NetworkInterfaceName>,
	
	pub(crate) broadcast_address: Option<IPA>,
	
	pub(crate) anycast_address: Option<IPA>,
	...
	pub(crate) route_priority: Option<u32>,
...
impl<IPA: InternetProtocolAddress> GetAddressMessageData<IPA>
{
	/// Such as `eth0`.
	#[inline(always)]
	pub fn interface_name(&self) -> Option<&NetworkInterfaceName>
	{
		self.label.as_ref()
	}
	...
	#[inline(always)]
	pub(crate) fn new(message_header: &ifaddrmsg) -> Self
	{
		Self
		{
