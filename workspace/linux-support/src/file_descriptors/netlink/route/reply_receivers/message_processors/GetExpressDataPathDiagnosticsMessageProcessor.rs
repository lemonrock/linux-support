...
impl MessageProcessor for GetExpressDataPathDiagnosticsMessageProcessor
{
	...
	{
		#[inline(always)]
		fn set_field_error<Field, Error: ToString, F: FnOnce(&rtattr<XDP_DIAG>) -> Result<Field, Error>>(field: &mut Option<Field>, message_attribute: &rtattr<XDP_DIAG>, attribute: F) -> Result<(), String>
		{
