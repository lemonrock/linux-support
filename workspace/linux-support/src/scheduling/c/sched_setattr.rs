...
#[inline(always)]
pub(super) fn sched_setattr(pid: pid_t, attr: *mut sched_attr, flags: c_uint) -> c_int
{
	SYS::sched_setattr.syscall3(pid as usize, attr as usize, flags as usize) as c_int
}
