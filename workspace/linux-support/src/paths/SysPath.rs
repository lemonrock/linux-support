...
impl SysPath
{
	...
	#[inline(always)]
	pub(crate) fn network_interface_class_net_queues_folder_path(&self, network_interface_name: &NetworkInterfaceName) -> PathBuf
	{
		self.network_interface_class_net_folder_path(network_interface_name).append("queues")
	}
