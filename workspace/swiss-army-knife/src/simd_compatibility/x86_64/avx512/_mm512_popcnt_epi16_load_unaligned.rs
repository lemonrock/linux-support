...
/// Calculates the population count of 32 `u16`s pointed to be source pointer; loads directly from memory.
///
/// Similar to the intrinsic `_mm512_popcnt_epi16()` but loads directly from memory.
