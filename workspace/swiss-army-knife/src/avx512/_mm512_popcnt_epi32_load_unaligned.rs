...
/// Calculates the population count of 16 `u32`s pointed to be source pointer; loads directly from memory.
///
/// Similar to the intrinsic `_mm512_popcnt_epi32()` but loads directly from memory.
