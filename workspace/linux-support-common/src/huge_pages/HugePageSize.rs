...
impl HugePageSize
{
	...
	/// Will only work as root.
	#[inline(always)]
	pub fn unreserve_numa_huge_pages(self, sys_path: &SysPath, numa_node: NumaNode) -> io::Result<()>
	{
	...
	/// Will only work as root.
	#[inline(always)]
	pub fn reserve_numa_huge_pages(self, sys_path: &SysPath, numa_node: NumaNode, number_to_try_to_reserve: u64) -> io::Result<()>
	{
